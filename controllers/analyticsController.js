...
exports.getDashboardAnalytics = async (req, res) => {
  try {
    ...
    if (startDate && endDate) {
      ...
      filterStartDate.setUTCHours(0 - TIMEZONE_OFFSET_HOURS, 0, 0, 0);

      filterEndDate = new Date(endDate);
      filterEndDate.setUTCHours(23 - TIMEZONE_OFFSET_HOURS, 59, 59, 999);
    }

    else if (dateRange === 'all') {
      // ✅ All time — no date filter at all
      filterStartDate = new Date('2000-01-01'); // far past
